...
const { unlockWithPassword, sendAnalyticsOtp, verifyAnalyticsOtp } = require('../controllers/analyticsSecurityController');

// All analytics security routes require authentication and at least manager role (admin always allowed)
router.use(authenticate);
router.use(requireManager);

router.post('/password/unlock', unlockWithPassword);
