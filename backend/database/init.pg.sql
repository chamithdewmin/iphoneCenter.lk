...
-- Warranty + condition (used by warranty checker and product forms)
ALTER TABLE products
...
CREATE INDEX IF NOT EXISTS idx_other_income_branch_date ON other_income(branch_id, income_date);
