      ...
      <NavLink
        ...
        className={({ isActive }) =>
          cn(
            ...
            "hover:bg-secondary/60 active:bg-[var(--sidebar-active-bg)] active:text-primary",
            isActive
...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-2 top-1/2 -translate-y-1/2 z-50 h-[calc(100vh-45px)] bg-card border border-secondary rounded-2xl transition-all duration-200 lg:translate-x-0",
