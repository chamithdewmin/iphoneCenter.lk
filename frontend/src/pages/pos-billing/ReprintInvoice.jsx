...
const ReprintInvoice = () => {
  ...
  const handleReprint = (order) => {
    toast({
      ...
      description: `Reprinting invoice for ${order.id}`,
    });
  ...
  return (
    <>
      <Helmet>
        <title>Reprint Invoice - iphone center.lk</title>
        <meta name="description" content="Reprint invoice for sale" />
      </Helmet>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Reprint invoice for previous orders</p>
        </div>
        ...
        {filteredOrders.length === 0 ? (
          ...
          >
            ...
            <p className="text-muted-foreground">
              {orders.length === 0 
                ? "No orders available to reprint"
