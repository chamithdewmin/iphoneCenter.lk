...
import { Search, Send, Receipt, FileText } from 'lucide-react';
...
const Invoice = () => {
  ...
  const handleSend = (order) => {
    toast({
      ...
      description: `Invoice SMS sent to ${order.customerName || order.customer?.name || 'customer'}`,
    });
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Send invoice via SMS" />
      </Helmet>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Send invoice details via SMS to customers</p>
        </div>
        ...
        {filteredOrders.length === 0 ? (
          ...
          >
            ...
            <p className="text-muted-foreground">No orders available to send invoice SMS</p>
          </motion.div>
        ) : (
